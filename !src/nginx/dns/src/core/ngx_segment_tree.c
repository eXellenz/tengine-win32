...
#if !(NGX_WIN32)
#define ngx_segment_node_copy(s, t) ({ (s)->key = (t)->key; (s)->data = (t)->data; })
#else
void ngx_segment_node_copy(ngx_segment_node_t*, ngx_segment_node_t*);
#endif
...
#if (NGX_WIN32)
void
ngx_segment_node_copy(ngx_segment_node_t *s, ngx_segment_node_t *t)
{
	s->key = t->key;
	s->data = t->data;
}
